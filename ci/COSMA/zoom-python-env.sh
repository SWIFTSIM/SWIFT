...
python3 -m pip install numpy h5py unyt pyerfa astropy pyyaml swiftsimio==12.0.0 || return 1

python3 -c "import numpy, h5py, unyt, pyerfa, astropy, yaml, swiftsimio" || return 1
