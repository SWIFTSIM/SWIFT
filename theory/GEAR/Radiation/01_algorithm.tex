...
$Z/Z_\odot\approx0.231$ (Sections~\ref{sec:matrix-gas20}--\ref{sec:matrix-gas95},
the e10 check) was therefore run at the wrong reference temperature;
...
\subsection{Adaptive rebuild cadence (opt-in, implemented and verified
2026-07-18)}
...
completed cleanly with sane, bounded $r_{\rm HII}$; the e10 diagnostic
(Section~\ref{sec:e10}) showed a real, quantified improvement (time to
reach $R_{\rm st}$ roughly $47\%$ faster) without fully closing that
