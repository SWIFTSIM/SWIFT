...
sign-closure or accuracy criterion, one carries an initially
undercounted particle-update cost of $+21$ to $+29\%$ once measured
correctly, and one depends on a kernel-membership test that a
uniform-resolution fixture cannot exercise but a real galaxy's
density contrast can. The choice of propagation-speed definition, if
