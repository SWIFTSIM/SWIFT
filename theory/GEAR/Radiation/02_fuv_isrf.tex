...
items~T5 (the open-items section of the HII photoionization logbook)
and~T6 (this document's own open-items list,
Section~\ref{sec:isrf-open}): what Grackle (the frozen,
...
photoionization logbook's algorithm section):
...
$13.6\,$eV, the HII photoionization logbook's blackbody-fit section)
...
used for the HII budget (the HII photoionization logbook's algorithm
...
splitting, documented in the HII photoionization logbook's algorithm
section).
