...
not a general source-normalisation one. Whether the cancellation still
holds under cosmology, where the Hubble term does not scale with
$c_{\rm hyp}$, is unmeasured and needs an operator ruling before a
cosmological run is trusted on this point.
...
(Section~\ref{sec:fuv-chyp-heterogeneity}'s own ``none is adopted, the
default stays scheme 0'' statement predates \code{a53ab8311} and needs
updating separately; not done here, out of this pass's scope.)
