...
2026-09-05, commit \code{9fa74a666}}, see below). $\rho_\star$ is
...
not resolved. So the cap in Eq.~\ref{eq:rp-sobolev} is a robustness
\emph{improvement over} what \citet{Hopkins2020} documents, not a
correction to match it -- adopted anyway
(\textbf{implemented 2026-09-05, commit \code{9fa74a666}}) once the
