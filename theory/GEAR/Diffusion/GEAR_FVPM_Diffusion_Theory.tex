...
\usepackage{tabularx}       % For fixed-width, line-wrapping table columns
\usepackage{seqsplit}
...
\newcommand{\dth}{\dt_{1/2}}                              % predictor half-timestep (Section~\ref{sec:predictor}), distinct from smoothing length h
...
\newcommand{\Rstiff}{\mathcal{R}}                         % Berthon-blend stiffness ratio tau_star/tau_num (Section~\ref{sec:berthon-blend})
