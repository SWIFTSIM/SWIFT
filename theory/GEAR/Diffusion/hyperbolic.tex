...
geometry -- area $\Aij$, position $\xij$, normal $\nunit$ -- as
...
(\code{chemistry\_riemann\_compute\_hyperbolic\_blending\_factor}),
derived in Section~\ref{sec:practical-tau0}. Only the mass-density
...
Section~\ref{sec:time-integration} -- subtracted from the left particle,
