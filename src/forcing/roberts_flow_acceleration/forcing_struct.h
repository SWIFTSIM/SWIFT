#ifndef SWIFT_FORCING_ROBERTS_FLOW_ACCELERATION_STRUCT_H
#define SWIFT_FORCING_ROBERTS_FLOW_ACCELERATION_STRUCT_H
...
#endif /* SWIFT_FORCING_ROBERTS_FLOW_ACCELERATION_STRUCT_H */