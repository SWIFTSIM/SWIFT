 ...
 *
 ******************************************************************************/
#ifndef SWIFT_QLA_EAGLE_COOL_TABLES_H
#define SWIFT_QLA_EAGLE_COOL_TABLES_H

/**
 * @file src/cooling/QLA_EAGLE/cooling.h
 * @brief QLA_EAGLE cooling function
 */
...
#define qla_eagle_cooling_N_loaded_redshifts 2

/*! Number of different bins along the temperature axis of the tables */
#define qla_eagle_cooling_N_temperature 176

/*! Number of different bins along the density axis of the tables */
#define qla_eagle_cooling_N_density 41

/*! Number of different bins along the metal axis of the tables */
#define qla_eagle_cooling_N_metal 9

/*! Number of different bins along the metal axis of the tables */
#define qla_eagle_cooling_N_He_frac 7
