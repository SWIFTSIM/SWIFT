...
void DOPAIR1_BRANCH(struct runner *r, struct cell *ci, struct cell *cj,
  ...
  /* #ifdef SWIFT_DEBUG_CHECKS */
  /*   /\* Pick-out the sorted lists. *\/ */
  /*   const struct sort_entry *restrict sort_i = cell_get_hydro_sorts(ci,
   * sid); */
  /*   const struct sort_entry *restrict sort_j = cell_get_hydro_sorts(cj,
   * sid); */
  ...
  /*     const struct part *p = &ci->hydro.parts[sort_i[p */
  /* id].i]; */
  ...
  /*             ci->width[0] * 1.0e-10) */
  /*       error( */
  /*           "particle shift diff exceeds dx_max_sort in cell ci.
   * ci->nodeID=%d " */
  /*           "cj->nodeID=%d d=%e sort_i[pid].d=%e ci->hydro.dx_max_sort=%e "
   */
  /*           "ci->hydro.dx_max_sort_old=%e", */
  /*           ci->nodeID, cj->nodeID, d, sort_i[pid].d,
   * ci->hydro.dx_max_sort, */
  ...
  /*           cj->nodeID, ci->nodeID, d, sort_j[pjd].d,
   * cj->hydro.dx_max_sort, */
