...
const char* timers_names[timer_count] = {
    ...
    "doself_force",
    "doself_limiter",
    "doself_dark_matter_density",
    "doself_dark_matter_limiter",
    "doself_sidm",
    ...
    "dopair_force",
    "dopair_limiter",
    "dopair_dark_matter_density",
    "dopair_dark_matter_limiter",
    "dopair_sidm",
    ...
    "dosub_self_force",
    "dosub_self_limiter",
    "dosub_self_dark_matter_density",
    "dosub_self_dark_matter_limiter",
    "dosub_self_sidm",
    ...
    "dosub_pair_force",
    "dosub_pair_limiter",
    "dosub_pair_dark_matter_density",
    "dosub_pair_dark_matter_limiter",
    "dosub_pair_sidm",
