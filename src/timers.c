...
const char *timers_names[timer_count] = {
    ...
    "dosub_self_sidm_density",
    "dosub_pair_density",
    "dosub_pair_gradient",
    "dosub_pair_force",
    "dosub_pair_limiter",
    "dosub_pair_stars_density",
    "dosub_pair_stars_sidm_density",
