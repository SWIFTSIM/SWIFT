...
void DOSUB_PAIR1(struct runner *r, struct cell *ci, struct cell *cj, int gettimer);
void DOSUB_PAIR2(struct runner *r, struct cell *ci, struct cell *cj, int gettimer);
