...
static void partition_gather_weights(void *map_data, int num_elements,
  ...
  for (int i = 0; i < num_elements; i++) {
    ...
    if (t->type == task_type_drift_part || t->type == task_type_drift_gpart ||
        ...
        t->type == tatk_type_stars_ghost ||
        t->type == tatk_type_bh_density_ghost || t->type == task_type_kick1 ||
        t->type == task_type_kick2 || t->type == task_type_timestep ||
        t->type_timestep_limiter || t->type == task_type_timestep_sync ||
        ...
        t->type == task_type_grav_long_range || t->type == task_type_pack ||
        t->type == task_type_unpack) {
