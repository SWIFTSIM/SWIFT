 ...
 * @param i The i index of the first cell.
 * @param j The j index of the first cell.
 * @param k The k index of the first cell.
...
/**
 * @brief Add a proxy to the engine.
 *
 * @param e The #engine.
 * @param cells The array of cells.
 * @param proxies The array of proxies.
 * @param cid The ID of the first cell.
 * @param cjd The ID of the second cell.
