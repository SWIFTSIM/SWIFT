  ...
  if (!fof && e->nodeID == 0) {
    ...
    if (!restart) {
      ...
      fprintf(e->file_timesteps,
              ...
              "Drifts", clocks_getunit(),
              "Sorts", clocks_getunit(),
              "Hyrdo", clocks_getunit(),
              "Hydro Ghost", clocks_getunit(),
              "Hydro Density", clocks_getunit(),
              "Gravity", clocks_getunit(),
              "Feedback", clocks_getunit(),
              "Time Integration", clocks_getunit(),
              "MPI", clocks_getunit(),
              "RT", clocks_getunit(),
              "Tchem", clocks_getunit(),
              "Others", clocks_getunit()
              );
