 ...
 *
 ******************************************************************************/
#ifndef SWIFT_DEFAULT_DARK_MATTER_IO_H
#define SWIFT_DEFAULT_DARK_MATTER_IO_H
...
/**
 * @brief Specifies which dm-particle fields to read from a dataset
 *
 * @param dmparts The dm-particle array.
 * @param list The list of i/o properties to read.
 * @param num_fields The number of i/o fields to read.
 */
INLINE static void darkmatter_read_particles(struct dmpart* dmparts,
