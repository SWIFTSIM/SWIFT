...
__attribute__((always_inline)) INLINE static void evolve_damage(
  ...
  evolve_damage_tensile(p, tensile_damage, stress_tensor, mat_id, mass, density, *damage, dt_therm);

  evolve_damage_shear(p, shear_damage, deviatoric_stress_tensor, mat_id, density, u, yield_stress, dt_therm);
...
__attribute__((always_inline)) INLINE static void hydro_predict_evolve_damage(
    ...
    evolve_damage(p, &p->strength_data.tensile_damage, &p->strength_data.shear_damage, &p->strength_data.damage, 
...
__attribute__((always_inline)) INLINE static void hydro_kick_evolve_damage(
    ...
    evolve_damage(p, &xp->strength_data.tensile_damage_full, &xp->strength_data.shear_damage_full, &xp->strength_data.damage_full, 
                  stress_tensor, deviatoric_stress_tensor, mat_id, mass, density, u, yield_stress, dt_therm);
}
...
__attribute__((always_inline)) INLINE static void set_dD_dt(
  ...
  calculate_tensile_dD_dt(p, &tensile_dD_dt, stress_tensor, mat_id, mass, density, damage, tensile_damage);
