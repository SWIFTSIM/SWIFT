...
void read_ic_single(
    ...
    struct sipart **siparts, size_t *Ngas, size_t *Ndm, size_t *Ndm_background,
    size_t *Nnuparts, size_t *Nsinks, size_t *Nstars, size_t *Nblackholes,
    size_t *Nsidm, int *flag_entropy, const int with_hydro,
    const int with_gravity, const int with_sinks, const int with_stars,
    const int with_black_holes, const int with_sidm, const int with_cosmology,
