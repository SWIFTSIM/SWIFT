 ...
 * output) as OPTIONAL fields into #feedback_part_data.u.
 ...
 * longer zeroes #feedback_part_data.u (and seeds
 * #feedback_part_data.u_prev from it, not from 0.f, so a supplied value also
 * survives the very first propagation update when
