 ...
 * separately (#dissipation_alpha_trigger,
 ...
 * @param alpha_trigger_i Particle i's #dissipation_alpha_trigger
 * (this band).
 * @param alpha_trigger_j Particle j's #dissipation_alpha_trigger
 * (this band).
 * @param alpha_floor_i Particle i's #dissipation_alpha_floor (this
 * band).
 * @param alpha_floor_j Particle j's #dissipation_alpha_floor (this
 * band).
...
__attribute__((always_inline)) INLINE static void runner_iact_isrf_propagation(
  ...
  radiation_divergence_accumulate_band(
      dx, r_inv, wi_dr, wj_dr, mi, mj, rho_i, rho_j,
      fdi->specific_flux[ISRF_BAND_FUV], fdj->specific_flux[ISRF_BAND_FUV],
      a_factor_comoving_to_physical, &fdi->div_specific_flux[ISRF_BAND_FUV],
      &fdj->div_specific_flux[ISRF_BAND_FUV]);
  radiation_divergence_accumulate_band(
      dx, r_inv, wi_dr, wj_dr, mi, mj, rho_i, rho_j,
      fdi->specific_flux[ISRF_BAND_LW], fdj->specific_flux[ISRF_BAND_LW],
      a_factor_comoving_to_physical, &fdi->div_specific_flux[ISRF_BAND_LW],
      &fdj->div_specific_flux[ISRF_BAND_LW]);

  radiation_dissipation_reference_accumulate_band(
      wi, wj, mi, mj, rho_i, rho_j, fdi->u_prev[ISRF_BAND_FUV],
      fdj->u_prev[ISRF_BAND_FUV], &fdi->ngb_mean_abs_u_V[ISRF_BAND_FUV],
      &fdj->ngb_mean_abs_u_V[ISRF_BAND_FUV]);
  radiation_dissipation_reference_accumulate_band(
      wi, wj, mi, mj, rho_i, rho_j, fdi->u_prev[ISRF_BAND_LW],
      fdj->u_prev[ISRF_BAND_LW], &fdi->ngb_mean_abs_u_V[ISRF_BAND_LW],
      &fdj->ngb_mean_abs_u_V[ISRF_BAND_LW]);
}
...
__attribute__((always_inline)) INLINE static void runner_iact_isrf_gradient(
  ...
  radiation_get_m1_closure_tensor_band(fdi->u[ISRF_BAND_FUV],
                                       fdi->specific_flux[ISRF_BAND_FUV],
                                       fdi->c_hyp, D_FUV_i);
  radiation_get_m1_closure_tensor_band(fdj->u[ISRF_BAND_FUV],
                                       fdj->specific_flux[ISRF_BAND_FUV],
                                       fdj->c_hyp, D_FUV_j);
  radiation_get_m1_closure_tensor_band(fdi->u[ISRF_BAND_LW],
                                       fdi->specific_flux[ISRF_BAND_LW],
                                       fdi->c_hyp, D_LW_i);
  radiation_get_m1_closure_tensor_band(fdj->u[ISRF_BAND_LW],
                                       fdj->specific_flux[ISRF_BAND_LW],
                                       fdj->c_hyp, D_LW_j);

  radiation_gradient_accumulate_band(
      dx, r_inv, wi_dr, wj_dr, mi, mj, rho_i, rho_j, fdi->u[ISRF_BAND_FUV],
      fdj->u[ISRF_BAND_FUV], D_FUV_i, D_FUV_j, a_factor_comoving_to_physical,
      fdi->grad_u[ISRF_BAND_FUV], fdj->grad_u[ISRF_BAND_FUV]);
  radiation_gradient_accumulate_band(
      dx, r_inv, wi_dr, wj_dr, mi, mj, rho_i, rho_j, fdi->u[ISRF_BAND_LW],
      fdj->u[ISRF_BAND_LW], D_LW_i, D_LW_j, a_factor_comoving_to_physical,
      fdi->grad_u[ISRF_BAND_LW], fdj->grad_u[ISRF_BAND_LW]);
}
...
runner_iact_nonsym_isrf_gradient(const float r2, const float dx[3],
  ...
  radiation_gradient_accumulate_band(
      dx, r_inv, wi_dr, wj_dr, mi, mj, rho_i, rho_j, fdi->u[ISRF_BAND_FUV],
      fdj->u[ISRF_BAND_FUV], D_FUV_i, D_FUV_j, a_factor_comoving_to_physical,
      fdi->grad_u[ISRF_BAND_FUV], unused_grad_u_FUV);
  radiation_gradient_accumulate_band(
      dx, r_inv, wi_dr, wj_dr, mi, mj, rho_i, rho_j, fdi->u[ISRF_BAND_LW],
      fdj->u[ISRF_BAND_LW], D_LW_i, D_LW_j, a_factor_comoving_to_physical,
      fdi->grad_u[ISRF_BAND_LW], unused_grad_u_LW);
}
 ...
 * extra ghost has set this step's #dissipation_alpha_trigger and
 * #dissipation_alpha_floor: reads the live
...
__attribute__((always_inline)) INLINE static void runner_iact_isrf_dissipation(
  ...
  radiation_dissipation_force_accumulate_band(
      ...
      fdi->dissipation_alpha_trigger[ISRF_BAND_FUV],
      fdj->dissipation_alpha_trigger[ISRF_BAND_FUV],
      fdi->dissipation_alpha_floor[ISRF_BAND_FUV],
      fdj->dissipation_alpha_floor[ISRF_BAND_FUV], fdi->u[ISRF_BAND_FUV],
      fdj->u[ISRF_BAND_FUV], a_factor_comoving_to_physical,
      &fdi->dissipation_u[ISRF_BAND_FUV], &fdj->dissipation_u[ISRF_BAND_FUV]);
  radiation_dissipation_force_accumulate_band(
      wi_dr, wj_dr, mi, mj, rho_i, rho_j, fdi->c_hyp, fdj->c_hyp,
      fdi->dissipation_alpha_trigger[ISRF_BAND_LW],
      fdj->dissipation_alpha_trigger[ISRF_BAND_LW],
      fdi->dissipation_alpha_floor[ISRF_BAND_LW],
      fdj->dissipation_alpha_floor[ISRF_BAND_LW], fdi->u[ISRF_BAND_LW],
      fdj->u[ISRF_BAND_LW], a_factor_comoving_to_physical,
      &fdi->dissipation_u[ISRF_BAND_LW], &fdj->dissipation_u[ISRF_BAND_LW]);
}
...
runner_iact_nonsym_isrf_dissipation(const float r2, const float dx[3],
  ...
  radiation_dissipation_force_accumulate_band(
      ...
      fdj->dissipation_alpha_floor[ISRF_BAND_FUV], fdi->u[ISRF_BAND_FUV],
      fdj->u[ISRF_BAND_FUV], a_factor_comoving_to_physical,
      &fdi->dissipation_u[ISRF_BAND_FUV], &unused_dissipation_u_FUV);
  radiation_dissipation_force_accumulate_band(
      wi_dr, wj_dr, mi, mj, rho_i, rho_j, fdi->c_hyp, fdj->c_hyp,
      fdi->dissipation_alpha_trigger[ISRF_BAND_LW],
      fdj->dissipation_alpha_trigger[ISRF_BAND_LW],
      ...
      fdj->dissipation_alpha_floor[ISRF_BAND_LW], fdi->u[ISRF_BAND_LW],
      fdj->u[ISRF_BAND_LW], a_factor_comoving_to_physical,
      &fdi->dissipation_u[ISRF_BAND_LW], &unused_dissipation_u_LW);
}
