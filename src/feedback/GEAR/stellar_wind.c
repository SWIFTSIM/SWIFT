...
void stellar_wind_read_yields_array(
  ...
  *previous_count = count;
  ...
  interpolate_2d_init_uniform_x(
      interp, log_metallicity_min, log_metallicity_max, interpolation_size_z,
      log_mass_min, log_mass_max, interpolation_size_m, log_metallicity_min,
      log_mass_min, step_size_z, step_size_m, Nz, Nm, data,
