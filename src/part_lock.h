...
typedef volatile signed char swift_particle_lock_t;
 ...
 * @param r Pointer to the runner locking the particle.
 */
#define swift_particle_lock_unlock(p) ({ atomic_cas(&((p)->lock), 1, -1); })
