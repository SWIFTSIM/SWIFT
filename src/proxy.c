...
void proxy_parts_exchange_second(struct proxy *p) {
  ...
  if (p->nr_parts_in > 0) {
    ...
    /* message("receiving parts %lli, x=[%.3e %.3e %.3e], h=%.3e, from node
     * %i.", */
  ...
  if (p->nr_sparts_in > 0) {
    ...
    /*       message( */
    /*           "receiving sparts %lli, x=[%.3e %.3e %.3e], h=%.3e, from node
     * %i.", */
  ...
  if (p->nr_sinks_in > 0) {
    ...
    /*       message("receiving sinks %lli, x=[%.3e %.3e %.3e], h=%.3e, from
     * node %i.", */
    /*               p->sinks_in[k].id, p->sinks_in[k].x[0],
     * p->sinks_in[k].x[1], */
