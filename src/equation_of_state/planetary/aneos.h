...
INLINE static float ANEOS_pressure_from_entropy(float density, float entropy,
...
INLINE static float ANEOS_entropy_from_pressure(float density, float pressure,
                                                struct ANEOS_params *mat) {
...
INLINE static float ANEOS_soundspeed_from_entropy(float density, float entropy,
                                                  struct ANEOS_params *mat) {
