...
#ifndef SWIFT_REMIX_STRENGTH_IO_NONE_H
#define SWIFT_REMIX_STRENGTH_IO_NONE_H

/**
 * @file REMIX/strength/none/hydro_io_strength.h
...
#endif /* SWIFT_REMIX_STRENGTH_IO_NONE_H */