 ...
 *
 ******************************************************************************/
#ifndef SWIFT_PLANETARY_GIZMO_MFM_HYDRO_DEBUG_H
#define SWIFT_PLANETARY_GIZMO_MFM_HYDRO_DEBUG_H
...
__attribute__((always_inline)) INLINE static void hydro_debug_particle(
  ...
  printf(
      ...
      p->mat_id, p->rho, p->P, p->gradients.rho[0], p->gradients.rho[1],
...
#endif /* SWIFT_PLANETARY_GIZMO_MFM_HYDRO_DEBUG_H */
