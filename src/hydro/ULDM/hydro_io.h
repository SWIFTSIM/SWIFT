...
INLINE static void convert_part_quantum_potential(const struct engine *e,
                                          const struct part *p,
                                          const struct xpart *xp, float *ret) {
...
INLINE static void hydro_write_particles(const struct part *parts,
  ...
  *num_fields = 14;
  ...
  list[11] = io_make_output_field_convert_part(
      "NormGradDensities", FLOAT, 1, UNIT_CONV_NO_UNITS, 0.f, parts, xparts,
      convert_part_norm_gradient_density,
      "Unit code norm of the density gradient at position of the particles");
  ...
  list[13] = io_make_output_field_convert_part(
      "QuantumPotential", FLOAT, 1, UNIT_CONV_NO_UNITS, 0.f, parts, xparts,
      convert_part_quantum_potential,
      "Unit code quantum potential at position of the particles");
