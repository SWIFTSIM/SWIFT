...
#ifndef SWIFT_PLANETARY_STRENGTH_IO_DEFAULT_H
#define SWIFT_PLANETARY_STRENGTH_IO_DEFAULT_H

/**
 * @file Planetary/strength/default/hydro_io_strength.h
...
#endif /* SWIFT_PLANETARY_STRENGTH_IO_DEFAULT_H */