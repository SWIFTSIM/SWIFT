 ...
 *
 ******************************************************************************/
#ifndef SWIFT_PLANETARY_STRENGTH_NONE_H
#define SWIFT_PLANETARY_STRENGTH_NONE_H

/**
 * @file Planetary/strength/none/hydro_strength.h
 * @brief Planetary implementation of SPH with no material strength
 */
...
#endif /* SWIFT_PLANETARY_STRENGTH_NONE_H */
