 ...
 *
 ******************************************************************************/
#ifndef SWIFT_SIMBA_CHEMISTRY_IACT_H
#define SWIFT_SIMBA_CHEMISTRY_IACT_H

/**
 * @file SIMBA/chemistry_iact.h
 * @brief Smooth metal interaction functions following the SIMBA model.
 */
...
#endif /* SWIFT_SIMBA_CHEMISTRY_IACT_H */
