 ...
 *
 ******************************************************************************/
#ifndef SWIFT_CHEMISTRY_GEAR_FVPM_DIFFUSION_GRADIENTS_H
#define SWIFT_CHEMISTRY_GEAR_FVPM_DIFFUSION_GRADIENTS_H
...
chemistry_gradients_predict_hydro(struct part *restrict pi,
  ...
  chemistry_slope_limit_face_hydro(Wi, Wj, dvi_ext, dvj_ext, xij_i, xij_j, r);
 ...
 * "metal".
 *
 * Predict the value at point x_ij given current values at particle
