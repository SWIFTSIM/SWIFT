...
__attribute__((always_inline, const)) INLINE static float D_soft_1(
    const float u, const float u_inv) {
...
__attribute__((always_inline, const)) INLINE static float D_soft_3(
    const float u, const float u_inv) {
...
__attribute__((always_inline, const)) INLINE static float D_soft_5(
    const float u, const float u_inv) {
...
__attribute__((always_inline, const)) INLINE static float D_soft_7(
    const float u, const float u_inv) {
...
__attribute__((always_inline, const)) INLINE static float D_soft_9(
    const float u, const float u_inv) {

  return (315.f - 420.f * u_inv * u_inv) * u_inv;
}

__attribute__((always_inline, const)) INLINE static float D_soft_11(
    const float u, const float u_inv) {

  return (1260.f * u_inv * u_inv - 315.f) * u_inv * u_inv * u_inv;
}
