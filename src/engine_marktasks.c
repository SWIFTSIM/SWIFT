        ...
        /* Only interested in dark matter sidm tasks as of here. */
          ...
          if (ci_nodeID != nodeID) {
              ...
              if (ci_active_dark_matter) {
                  ...
                  struct link *l = scheduler_activate_send(s, cj->mpi.send, task_subtype_dmpart, ci_nodeID);
              ...
              if (cj_active_dark_matter)
                  ...
                  if (cj_active_dark_matter) {
                      ...
                      struct link *l = scheduler_activate_send(s, ci->mpi.send, task_subtype_dmpart, cj_nodeID);
