...
__attribute__((always_inline)) INLINE static void runner_iact_mhd_gradient(
  ...
  Cos_Ind_Diffi = sqrtf(Adv_B_sourcei[0]*Delta_Bi[0]+Adv_B_sourcei[1]*Delta_Bi[1]+Adv_B_sourcei[2]*Delta_Bi[2])/(Abs_Adv_B_sourcei*Abs_Delta_Bi+FLT_MIN);
  ...
  Cos_Ind_Diffj = sqrtf(Adv_B_sourcej[0]*Delta_Bj[0]+Adv_B_sourcej[1]*Delta_Bj[1]+Adv_B_sourcej[2]*Delta_Bj[2])/(Abs_Adv_B_sourcej*Abs_Delta_Bj+FLT_MIN);
