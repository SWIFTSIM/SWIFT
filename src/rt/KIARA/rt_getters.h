...
#ifndef SWIFT_KIARA_RT_GETTERS_H
#define SWIFT_KIARA_RT_GETTERS_H

#include "rt_parameters.h"

/**
 * @file src/rt/KIARA/rt_getters.h
 * @brief Getter functions for KIARA RT scheme to keep code clean and lean
 */
