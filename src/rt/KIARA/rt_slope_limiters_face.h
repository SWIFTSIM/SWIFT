 ...
 *
 ******************************************************************************/
#ifndef SWIFT_RT_SLOPE_LIMITERS_FACE_KIARA_H
#define SWIFT_RT_SLOPE_LIMITERS_FACE_KIARA_H

#include "sign.h"

/**
 * @file src/rt/KIARA/rt_slope_limiters_face.h
 * @brief File containing routines concerning the face slope
 * limiter for the KIARA RT scheme, i.e. limiting the actual
 * interparticle flux. */
...
#endif /* SWIFT_RT_SLOPE_LIMITERS_FACE_KIARA_H */
