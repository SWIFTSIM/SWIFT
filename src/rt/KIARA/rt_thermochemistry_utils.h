 ...
 *
 ******************************************************************************/
#ifndef SWIFT_RT_KIARA_THERMOCHEMISTRY_UTILS_H
#define SWIFT_RT_KIARA_THERMOCHEMISTRY_UTILS_H

/**
 * @file src/rt/KIARA/rt_thermochemistry_utils.h
...
#endif /* SWIFT_RT_KIARA_THERMOCHEMISTRY_UTILS_H */
