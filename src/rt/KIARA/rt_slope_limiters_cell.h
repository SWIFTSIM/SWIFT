 ...
 *
 ******************************************************************************/
#ifndef SWIFT_RT_SLOPE_LIMITERS_CELL_KIARA_H
#define SWIFT_RT_SLOPE_LIMITERS_CELL_KIARA_H

/**
 * @file src/rt/KIARA/rt_slope_limiters_cell.h
 * @brief File containing routines concerning the cell slope
 * limiter for the KIARA RT scheme. (= fist slope limiting step
...
#endif /* SWIFT_RT_SLOPE_LIMITERS_CELL_KIARA_H */
