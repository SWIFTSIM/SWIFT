 ...
 *
 ******************************************************************************/
#ifndef SWIFT_GEAR_BLACK_HOLES_IO_H
#define SWIFT_GEAR_BLACK_HOLES_IO_H
...
INLINE static void black_holes_write_particles(const struct bpart *bparts,
  ...
  *num_fields = 42;
  ...
  list[38] = io_make_output_field_convert_bpart(
  ...
  list[41] = io_make_output_field_convert_bpart(
...
#endif /* SWIFT_GEAR_BLACK_HOLES_IO_H */
