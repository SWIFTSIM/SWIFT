 ...
 *
 ******************************************************************************/
#ifndef SWIFT_GEAR_BLACK_HOLE_PART_H
#define SWIFT_GEAR_BLACK_HOLE_PART_H

/*! The total number of rays used in AGN feedback */
#define gear_blackhole_number_of_rays FEEDBACK_NR_RAYS_AGN
...
struct bpart {
  ...
  struct ray_data rays[gear_blackhole_number_of_rays];
...
#endif /* SWIFT_GEAR_BLACK_HOLE_PART_H */
