...
__attribute__((nonnull)) INLINE static int gravity_multipole_equal(
  ...
  /* Check CoM */
  if (2. * fabs(ga->CoM[0] - gb->CoM[0]) / fabs(ga->CoM[0] + gb->CoM[0]) >
      tolerance) {
    message("CoM[0] different");
    return 0;
  }
  if (2. * fabs(ga->CoM[1] - gb->CoM[1]) / fabs(ga->CoM[1] + gb->CoM[1]) >
      tolerance) {
    message("CoM[1] different");
    return 0;
  }
  if (2. * fabs(ga->CoM[2] - gb->CoM[2]) / fabs(ga->CoM[2] + gb->CoM[2]) >
      tolerance) {
  ...
  if (2.f * fabsf(ma->max_softening - mb->max_softening) /
  ...
  if (2.f * fabsf(ma->min_old_a_grav_norm - mb->min_old_a_grav_norm) /
  ...
  if (((fabsf(ma->M_000) > 0.001f * order0_norm) ||
      ...
      2.f * fabsf(ma->M_000 - mb->M_000) / fabsf(ma->M_000 + mb->M_000) >
          tolerance) {
    message("M_000 term different");
    message("Note: order0_norm = %e", order0_norm);
    return 0;
  }
  ...
  /* Nothing to do here as 1st order m-poles don't exist
   * All 0 by definition. */
#endif
#if SELF_GRAVITY_MULTIPOLE_ORDER > 1
  ...
  if (((fabsf(ma->M_002) > 0.001f * order2_norm) ||
      ...
      2.f * fabsf(ma->M_002 - mb->M_002) / fabsf(ma->M_002 + mb->M_002) >
          tolerance) {
    message("M_002 term different");
    message("Note: order2_norm = %e", order2_norm);
    return 0;
  }
  if (((fabsf(ma->M_011) > 0.001f * order2_norm) ||
       (fabsf(mb->M_011) > 0.001f * order2_norm)) &&
      2.f * fabsf(ma->M_011 - mb->M_011) / fabsf(ma->M_011 + mb->M_011) >
          tolerance) {
  ...
  if (((fabsf(ma->M_020) > 0.001f * order2_norm) ||
      ...
      2.f * fabsf(ma->M_020 - mb->M_020) / fabsf(ma->M_020 + mb->M_020) >
          tolerance) {
  ...
  if (((fabsf(ma->M_101) > 0.001f * order2_norm) ||
      ...
      2.f * fabsf(ma->M_101 - mb->M_101) / fabsf(ma->M_101 + mb->M_101) >
          tolerance) {
  ...
  if (((fabsf(ma->M_110) > 0.001f * order2_norm) ||
      ...
      2.f * fabsf(ma->M_110 - mb->M_110) / fabsf(ma->M_110 + mb->M_110) >
          tolerance) {
  ...
  if (((fabsf(ma->M_200) > 0.001f * order2_norm) ||
      ...
      2.f * fabsf(ma->M_200 - mb->M_200) / fabsf(ma->M_200 + mb->M_200) >
          tolerance) {
  ...
  if (((fabsf(ma->M_003) > 0.001f * order3_norm) ||
      ...
      2.f * fabsf(ma->M_003 - mb->M_003) / fabsf(ma->M_003 + mb->M_003) >
          tolerance) {
    message("M_003 term different");
    message("Note: order3_norm = %e", order3_norm);
    return 0;
  }
  if (((fabsf(ma->M_012) > 0.001f * order3_norm) ||
       (fabsf(mb->M_012) > 0.001f * order3_norm)) &&
      2.f * fabsf(ma->M_012 - mb->M_012) / fabsf(ma->M_012 + mb->M_012) >
          tolerance) {
  ...
  if (((fabsf(ma->M_021) > 0.001f * order3_norm) ||
      ...
      2.f * fabsf(ma->M_021 - mb->M_021) / fabsf(ma->M_021 + mb->M_021) >
          tolerance) {
  ...
  if (((fabsf(ma->M_030) > 0.001f * order3_norm) ||
      ...
      2.f * fabsf(ma->M_030 - mb->M_030) / fabsf(ma->M_030 + mb->M_030) >
          tolerance) {
  ...
  if (((fabsf(ma->M_102) > 0.001f * order3_norm) ||
      ...
      2.f * fabsf(ma->M_102 - mb->M_102) / fabsf(ma->M_102 + mb->M_102) >
          tolerance) {
  ...
  if (((fabsf(ma->M_111) > 0.001f * order3_norm) ||
      ...
      2.f * fabsf(ma->M_111 - mb->M_111) / fabsf(ma->M_111 + mb->M_111) >
          tolerance) {
  ...
  if (((fabsf(ma->M_120) > 0.001f * order3_norm) ||
      ...
      2.f * fabsf(ma->M_120 - mb->M_120) / fabsf(ma->M_120 + mb->M_120) >
          tolerance) {
  ...
  if (((fabsf(ma->M_201) > 0.001f * order3_norm) ||
      ...
      2.f * fabsf(ma->M_201 - mb->M_201) / fabsf(ma->M_201 + mb->M_201) >
          tolerance) {
  ...
  if (((fabsf(ma->M_210) > 0.001f * order3_norm) ||
      ...
      2.f * fabsf(ma->M_210 - mb->M_210) / fabsf(ma->M_210 + mb->M_210) >
          tolerance) {
  ...
  if (((fabsf(ma->M_300) > 0.001f * order3_norm) ||
      ...
      2.f * fabsf(ma->M_300 - mb->M_300) / fabsf(ma->M_300 + mb->M_300) >
          tolerance) {
  ...
  if (((fabsf(ma->M_004) > 0.001f * order4_norm) ||
      ...
      2.f * fabsf(ma->M_004 - mb->M_004) / fabsf(ma->M_004 + mb->M_004) >
          tolerance) {
    message("M_004 term different");
    message("Note: order4_norm = %e", order4_norm);
    return 0;
  }
  if (((fabsf(ma->M_013) > 0.001f * order4_norm) ||
       (fabsf(mb->M_013) > 0.001f * order4_norm)) &&
      2.f * fabsf(ma->M_013 - mb->M_013) / fabsf(ma->M_013 + mb->M_013) >
          tolerance) {
  ...
  if (((fabsf(ma->M_022) > 0.001f * order4_norm) ||
      ...
      2.f * fabsf(ma->M_022 - mb->M_022) / fabsf(ma->M_022 + mb->M_022) >
          tolerance) {
  ...
  if (((fabsf(ma->M_031) > 0.001f * order4_norm) ||
      ...
      2.f * fabsf(ma->M_031 - mb->M_031) / fabsf(ma->M_031 + mb->M_031) >
          tolerance) {
  ...
  if (((fabsf(ma->M_040) > 0.001f * order4_norm) ||
      ...
      2.f * fabsf(ma->M_040 - mb->M_040) / fabsf(ma->M_040 + mb->M_040) >
          tolerance) {
  ...
  if (((fabsf(ma->M_103) > 0.001f * order4_norm) ||
      ...
      2.f * fabsf(ma->M_103 - mb->M_103) / fabsf(ma->M_103 + mb->M_103) >
          tolerance) {
  ...
  if (((fabsf(ma->M_112) > 0.001f * order4_norm) ||
      ...
      2.f * fabsf(ma->M_112 - mb->M_112) / fabsf(ma->M_112 + mb->M_112) >
          tolerance) {
  ...
  if (((fabsf(ma->M_121) > 0.001f * order4_norm) ||
      ...
      2.f * fabsf(ma->M_121 - mb->M_121) / fabsf(ma->M_121 + mb->M_121) >
          tolerance) {
  ...
  if (((fabsf(ma->M_130) > 0.001f * order4_norm) ||
      ...
      2.f * fabsf(ma->M_130 - mb->M_130) / fabsf(ma->M_130 + mb->M_130) >
          tolerance) {
  ...
  if (((fabsf(ma->M_202) > 0.001f * order4_norm) ||
      ...
      2.f * fabsf(ma->M_202 - mb->M_202) / fabsf(ma->M_202 + mb->M_202) >
          tolerance) {
  ...
  if (((fabsf(ma->M_211) > 0.001f * order4_norm) ||
      ...
      2.f * fabsf(ma->M_211 - mb->M_211) / fabsf(ma->M_211 + mb->M_211) >
          tolerance) {
  ...
  if (((fabsf(ma->M_220) > 0.001f * order4_norm) ||
      ...
      2.f * fabsf(ma->M_220 - mb->M_220) / fabsf(ma->M_220 + mb->M_220) >
          tolerance) {
  ...
  if (((fabsf(ma->M_301) > 0.001f * order4_norm) ||
      ...
      2.f * fabsf(ma->M_301 - mb->M_301) / fabsf(ma->M_301 + mb->M_301) >
          tolerance) {
  ...
  if (((fabsf(ma->M_310) > 0.001f * order4_norm) ||
      ...
      2.f * fabsf(ma->M_310 - mb->M_310) / fabsf(ma->M_310 + mb->M_310) >
          tolerance) {
  ...
  if (((fabsf(ma->M_400) > 0.001f * order4_norm) ||
      ...
      2.f * fabsf(ma->M_400 - mb->M_400) / fabsf(ma->M_400 + mb->M_400) >
          tolerance) {
  ...
  if (((fabsf(ma->M_005) > 0.001f * order5_norm) ||
      ...
      2.f * fabsf(ma->M_005 - mb->M_005) / fabsf(ma->M_005 + mb->M_005) >
          tolerance) {
    message("M_005 term different");
    message("Note: order5_norm = %e", order5_norm);
    return 0;
  }
  if (((fabsf(ma->M_014) > 0.001f * order5_norm) ||
       (fabsf(mb->M_014) > 0.001f * order5_norm)) &&
      2.f * fabsf(ma->M_014 - mb->M_014) / fabsf(ma->M_014 + mb->M_014) >
          tolerance) {
  ...
  if (((fabsf(ma->M_023) > 0.001f * order5_norm) ||
      ...
      2.f * fabsf(ma->M_023 - mb->M_023) / fabsf(ma->M_023 + mb->M_023) >
          tolerance) {
  ...
  if (((fabsf(ma->M_032) > 0.001f * order5_norm) ||
      ...
      2.f * fabsf(ma->M_032 - mb->M_032) / fabsf(ma->M_032 + mb->M_032) >
          tolerance) {
  ...
  if (((fabsf(ma->M_041) > 0.001f * order5_norm) ||
      ...
      2.f * fabsf(ma->M_041 - mb->M_041) / fabsf(ma->M_041 + mb->M_041) >
          tolerance) {
  ...
  if (((fabsf(ma->M_050) > 0.001f * order5_norm) ||
      ...
      2.f * fabsf(ma->M_050 - mb->M_050) / fabsf(ma->M_050 + mb->M_050) >
          tolerance) {
  ...
  if (((fabsf(ma->M_104) > 0.001f * order5_norm) ||
      ...
      2.f * fabsf(ma->M_104 - mb->M_104) / fabsf(ma->M_104 + mb->M_104) >
          tolerance) {
  ...
  if (((fabsf(ma->M_113) > 0.001f * order5_norm) ||
      ...
      2.f * fabsf(ma->M_113 - mb->M_113) / fabsf(ma->M_113 + mb->M_113) >
          tolerance) {
  ...
  if (((fabsf(ma->M_122) > 0.001f * order5_norm) ||
      ...
      2.f * fabsf(ma->M_122 - mb->M_122) / fabsf(ma->M_122 + mb->M_122) >
          tolerance) {
  ...
  if (((fabsf(ma->M_131) > 0.001f * order5_norm) ||
      ...
      2.f * fabsf(ma->M_131 - mb->M_131) / fabsf(ma->M_131 + mb->M_131) >
          tolerance) {
  ...
  if (((fabsf(ma->M_140) > 0.001f * order5_norm) ||
      ...
      2.f * fabsf(ma->M_140 - mb->M_140) / fabsf(ma->M_140 + mb->M_140) >
          tolerance) {
  ...
  if (((fabsf(ma->M_203) > 0.001f * order5_norm) ||
      ...
      2.f * fabsf(ma->M_203 - mb->M_203) / fabsf(ma->M_203 + mb->M_203) >
          tolerance) {
  ...
  if (((fabsf(ma->M_212) > 0.001f * order5_norm) ||
      ...
      2.f * fabsf(ma->M_212 - mb->M_212) / fabsf(ma->M_212 + mb->M_212) >
          tolerance) {
  ...
  if (((fabsf(ma->M_221) > 0.001f * order5_norm) ||
      ...
      2.f * fabsf(ma->M_221 - mb->M_221) / fabsf(ma->M_221 + mb->M_221) >
          tolerance) {
  ...
  if (((fabsf(ma->M_230) > 0.001f * order5_norm) ||
      ...
      2.f * fabsf(ma->M_230 - mb->M_230) / fabsf(ma->M_230 + mb->M_230) >
          tolerance) {
  ...
  if (((fabsf(ma->M_302) > 0.001f * order5_norm) ||
      ...
      2.f * fabsf(ma->M_302 - mb->M_302) / fabsf(ma->M_302 + mb->M_302) >
          tolerance) {
  ...
  if (((fabsf(ma->M_311) > 0.001f * order5_norm) ||
      ...
      2.f * fabsf(ma->M_311 - mb->M_311) / fabsf(ma->M_311 + mb->M_311) >
          tolerance) {
  ...
  if (((fabsf(ma->M_320) > 0.001f * order5_norm) ||
      ...
      2.f * fabsf(ma->M_320 - mb->M_320) / fabsf(ma->M_320 + mb->M_320) >
          tolerance) {
  ...
  if (((fabsf(ma->M_401) > 0.001f * order5_norm) ||
      ...
      2.f * fabsf(ma->M_401 - mb->M_401) / fabsf(ma->M_401 + mb->M_401) >
          tolerance) {
  ...
  if (((fabsf(ma->M_410) > 0.001f * order5_norm) ||
      ...
      2.f * fabsf(ma->M_410 - mb->M_410) / fabsf(ma->M_410 + mb->M_410) >
          tolerance) {
  ...
  if (((fabsf(ma->M_500) > 0.001f * order5_norm) ||
      ...
      2.f * fabsf(ma->M_500 - mb->M_500) / fabsf(ma->M_500 + mb->M_500) >
          tolerance) {
  ...
  for (int i = 0; i < SELF_GRAVITY_MULTIPOLE_ORDER + 1; ++i) {
    ...
    if (2.f * fabsf(ma->power[i] - mb->power[i]) /
...
__attribute__((nonnull)) INLINE static void gravity_M2P_tidaltensors(
  ...
  l->F_200 += M_200 * D_400 + M_110 * D_310 + M_101 * D_301 + M_020 * D_220 +
              M_011 * D_211 + M_002 * D_202;
  l->F_110 += M_200 * D_310 + M_110 * D_220 + M_101 * D_211 + M_020 * D_130 +
              M_011 * D_121 + M_002 * D_112;
  l->F_101 += M_200 * D_301 + M_110 * D_211 + M_101 * D_202 + M_020 * D_121 +
              M_011 * D_112 + M_002 * D_103;
  l->F_020 += M_200 * D_220 + M_110 * D_130 + M_101 * D_121 + M_020 * D_040 +
              M_011 * D_031 + M_002 * D_022;
  l->F_011 += M_200 * D_211 + M_110 * D_121 + M_101 * D_112 + M_020 * D_031 +
              M_011 * D_022 + M_002 * D_013;
  l->F_002 += M_200 * D_202 + M_110 * D_112 + M_101 * D_103 + M_020 * D_022 +
              M_011 * D_013 + M_002 * D_004;
  ...
  /*  4th order multipole term (addition to rank 2)*/
  l->F_200 += M_003 * D_203 + M_012 * D_212 + M_021 * D_221 + M_030 * D_230 +
              M_102 * D_302 + M_111 * D_311 + M_120 * D_320 + M_201 * D_401 +
              M_210 * D_410 + M_300 * D_500;
  l->F_110 += M_003 * D_113 + M_012 * D_122 + M_021 * D_131 + M_030 * D_140 +
              M_102 * D_212 + M_111 * D_221 + M_120 * D_230 + M_201 * D_311 +
              M_210 * D_320 + M_300 * D_410;
  l->F_101 += M_003 * D_104 + M_012 * D_113 + M_021 * D_122 + M_030 * D_131 +
              M_102 * D_203 + M_111 * D_212 + M_120 * D_221 + M_201 * D_302 +
              M_210 * D_311 + M_300 * D_401;
  l->F_020 += M_003 * D_023 + M_012 * D_032 + M_021 * D_041 + M_030 * D_050 +
              M_102 * D_122 + M_111 * D_131 + M_120 * D_140 + M_201 * D_221 +
              M_210 * D_230 + M_300 * D_320;
  l->F_011 += M_003 * D_014 + M_012 * D_023 + M_021 * D_032 + M_030 * D_041 +
              M_102 * D_113 + M_111 * D_122 + M_120 * D_131 + M_201 * D_212 +
              M_210 * D_221 + M_300 * D_311;
  l->F_002 += M_003 * D_005 + M_012 * D_014 + M_021 * D_023 + M_030 * D_032 +
              M_102 * D_104 + M_111 * D_113 + M_120 * D_122 + M_201 * D_203 +
              M_210 * D_212 + M_300 * D_302;

#endif

  /* Note: Nothing to do for higher orders as we don't have the derivatives */
...
#error "Missing implementation for order >5"
  ...
  gravity_add_comoving_tensor(gp, T_xx, T_yy, T_zz, T_xy, T_xz, T_yz);
