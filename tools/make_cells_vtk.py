...
def make_cells_vtk(input_file, output_basename):
    ...
    with open(output_basename + ".vdu", "w") as f:
        ...
        f.write("\t" * 2 + "   </PointData>\n")
        f.write("\t" * 2 + "   <CellData>\n")
        f.write("\t" * 2 + "   <DataArray type=Int32 Name=gpart_count>\n")
        f.write("\t" * 2 + "    ".join(map(str, cell_gpart_count)) + "\n")
        f.write("\t" * 2 + "   </DataArray>\n")
        f.write("\t" * 2 + "   <DataArray type=Int32 Name=hydro_count>\n")
        f.write("\t" * 2 + "    ".join(map(str, cell_hydro_count)) + "\n")
        f.write("\t" * 2 + "   </DataArray>\n")
        f.write("\t" * 2 + "   <DataArray type=Int32 Name=stars_count>\n")
        f.write("\t" * 2 + "    ".join(map(str, cell_stars_count)) + "\n")
        f.write("\t" * 2 + "   </DataArray>\n")
        f.write("\t" * 2 + "   <DataArray type=Int32 Name=mpi_rank>\n")
        f.write("\t" * 2 + "    ".join(map(str, cell_mpi_rank)) + "\n")
        f.write("\t" * 2 + "   </DataArray>\n")
        f.write("\t" * 2 + "   <DataArray type=Int32 Name=hydro_hmax>\n")
        f.write("\t" * 2 + "    ".join(map(str, cell_hydro_hmax)) + "\n")
        f.write("\t" * 2 + "   </DataArray>\n")
        f.write("\t" * 2 + "   <DataArray type=Int32 Name=stars_hmax>\n")
        f.write("\t" * 2 + "    ".join(map(str, cell_stars_hmax)) + "\n")
        f.write("\t" * 2 + "   </DataArray>\n")
        f.write("\t" * 2 + "   <DataArray type=Int32 Name=depth>\n")
        f.write("\t" * 2 + "    ".join(map(str, cell_depth)) + "\n")
        f.write("\t" * 2 + "   </DataArray>\n")
        f.write("\t" * 2 + "   <DataArray type=Int32 Name=is_super>\n")
        f.write("\t" * 2 + "    ".join(map(str, cell_is_super)) + "\n")
        f.write("\t" * 2 + "   </DataArray>\n")
        f.write("\t" * 2 + "   <DataArray type=Int32 Name=is_hydro_super>\n")
        f.write("\t" * 2 + "    ".join(map(str, cell_is_hydro_super)) + "\n")
        f.write("\t" * 2 + "   </DataArray>\n")
        f.write("\t" * 2 + "   </CellData>\n")
        f.write("\t" * 2 + "   </Piece>\n")
        f.write("\t" + "   </UnstructuredGrid>\n")
        ...
        # f.write(" ".join(map(str, range(0, npoint))) + "\n")
        # f.write("</DataArray>\n")
        # f.write("<DataArray type=Int32 Name=offsets>\n")
        # f.write(" ".join(map(str, range(8, npoint + 1, 8))) + "\n")
        # f.write("</DataArray>\n")
        # f.write("<DataArray type=UInt8 Name=types>\n")
        # f.write(" ".join(map(str, [11] * ncell)) + "\n")
        # f.write("</DataArray>\n")
