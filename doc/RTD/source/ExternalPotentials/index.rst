...
`AGAMA <https://agama.software/t>`_ library.

The AGAMA potential must be created outside SWIFT and stored as an ascii file.
Using the AGAMA python interface such a file can be obtained
...
An example of a potential AGAMA file corresponding to a multipole expansion of a Plummer sphere is
given below::
...
After having cloned AGAMA, in the root directory, type:: bash

  pip install --no-build-isolation .

Configuring SWIFT in order to link it with AGAMA is obtained with:: bash
