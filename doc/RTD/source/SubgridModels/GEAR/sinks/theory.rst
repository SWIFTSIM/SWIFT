...
Once a gas is eligible for accretion, its properties are assigned to the sink. The sink accretes the *entire* gas mass in step and its properties are updated in the following way:
