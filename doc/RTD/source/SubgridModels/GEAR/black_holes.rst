...
subgrid option, which also selects the GEAR chemistry, tracers, pressure floor,
stars, star formation, and feedback modules, plus Grackle cooling. 
...
This requires running with both ``--black-holes`` and ``--fof``. Black hole
