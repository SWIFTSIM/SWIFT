...
parser.add_argument("-a", type=float, default=0.1, help="Softening Length (in kpc)")
parser.add_argument(
    "-M", type=float, default=1.0e-2, help="Total Mass of Model (in 10^10 solar masses)"
)
parser.add_argument(
...
parser.add_argument(
    "-bound", type=float, default=20.0, help="Upper bound of radius sampling"
)
parser.add_argument("-boxsize", type=float, default=80.0, help="Box Size of simulation")
parser.add_argument(
    "--noparallel",
    action="store_false",
