...
agama.setUnits(mass=1e10,length=1,velocity=1e5)

# Create a potential based on the particle distribution
potential = agama.Potential(type='multipole',particles=(nb.pos, nb.mass),lmax=4, symmetry='nq',rmin=0., rmax=Rmax)
