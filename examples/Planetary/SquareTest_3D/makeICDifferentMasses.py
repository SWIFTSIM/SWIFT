...
# Generates a swift IC file for the 3D square test with equal particle spacing
...
# 3d mask
mask_inside = np.logical_and.reduce([A3_pos_x < 0.75, A3_pos_x > 0.25, A3_pos_y < 0.75, A3_pos_y > 0.25, A3_pos_z < 0.75, A3_pos_z > 0.25])
