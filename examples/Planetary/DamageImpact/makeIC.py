...
L_target = 200  # Number of particles on side of grid
boxsize = 20 / 100
vol = boxsize**3
...
rho_target = 2700
mat_id_target = 103
u_target = 0.07407407408291543#3e5
...
# Now make impactor in same way ass target
impactor_radius = 0.35 / 100 #cm 
rho_impactor = 1800
#rho_impactor = rho_target
mat_id_impactor = 103
u_impactor = 1655347#0.07407407408291543#3e5

L_impactor = int(L_target * cbrt(rho_target / rho_impactor))
