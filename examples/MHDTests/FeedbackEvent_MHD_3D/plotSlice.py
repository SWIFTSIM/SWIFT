...
data.gas.mass_weighted_pressures = data.gas.masses * data.gas.pressures / background_P
...
a01 = ax[0, 1].contourf(
    pressure_map.value.T, cmap="gist_heat", levels=np.linspace(0.0, 100.0, 100), extend='both'
)
a10 = ax[1, 0].contourf(
...
a20 = ax[2, 0].contourf(error_map.value.T, cmap="jet", levels=np.linspace(-5.0, 0.0, 100), extend='both')
