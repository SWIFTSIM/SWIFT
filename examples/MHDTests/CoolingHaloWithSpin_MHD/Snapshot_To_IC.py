...
path_to_IC = sys.argv[2]

# Make snapshot
def make_ICs_from_snapshot(path_to_snapshot,path_to_ICs="./CoolingHalo.hdf5"):
    ...
    grp.attrs["Unit current in cgs (U_I)"] = 2.088431e20
    grp.attrs["Unit temperature in cgs (U_T)"] = 1.0

    file.close()

make_ICs_from_snapshot(path_to_snapshot, path_to_IC)
