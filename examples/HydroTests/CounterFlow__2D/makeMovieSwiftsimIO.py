"""
Makes a movie of the counterFlow 2D data.
...
Written by Josh Borrow (joshua.borrow@durham.ac.uk). Adapted for counterFlow by r.g.bower@durham.ac.uk
"""
...
if __name__ == "__main__":
    ...
    anim.save("counterFlow_movie.mp4", dpi=dpi)
