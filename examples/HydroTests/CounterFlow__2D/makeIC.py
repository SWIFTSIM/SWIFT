...
# Generates a swift IC file for the counter flow problem in a periodic box. Assumes that this runs with weakly compressible SPH.

# Parameters
L2    = 256       # Particles along one edge in the low-density region
gamma = 1.        # equation of state index
P1    = 1.       # Central region pressure
P2    = 1.       # Outskirts pressure
v1    = 0.5       # Central region velocity
v2    = -0.5      # Outskirts vlocity
rho1  = 1.         # Central density
rho2  = 1         # Outskirts density
U1    = 1.        # internal energy of central region (used only as tracer)
U2    = 2.        # internal energy of outer region (used only as tracer)
omega0 = 0.1
sigma = 0.05 / sqrt(2)
fileOutputName = "counterFlow.hdf5" 
#---------------------------------------------------
...
# check these actually end up the same values (fluid have same density/pressure)
